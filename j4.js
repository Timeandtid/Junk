(function() {
	...
	var L = !0,
		...
		t = {
			...
			J: function(a, b) {
				var c = [];
				if (a instanceof J)
					for (var f = 0; f < a.i.length; f++) c = c.concat(t.J(a.i[f], b));
						...
						if (v = x[n], 0 < v.c) {
							...
							for (var B = 0; B < K; B++) {
								...
								for (var C = 0; C < w; C++) {
									...
									if (v.qa && I <= h)
										for (b.position = d.add(r, d.o(A, 8)), b.C = I - 8, b.direction = A, r = m.length, I = 0; I < r; I++)
											if (A = m[I], b.ia(A.na, A.ma))
												if (g++, b.ja(A.g, A.a, A.h, A.d, A.M)) {
													y = 0;
													e++;
													break
												} else l++;
									L ? v.m[B][C] = d.add(v.m[B][C] || d.create(), d.o(u, y / 255)) : (y = Math.min(255, (v.m[B][C] || y) + y), v.m[B][C] = y)
								}
							}
						}
				})
		...
		u = function() {
			...
			return {
				...
				za: function(a) {
					for (var b = 0, k = 0; k < M.length; k++) var p = M[k],
				...
				s: function(a) {
					var f = [],
						...
						l = "",
						e = u.da(a);
					e && ("-" == e.charAt(0) ? f.push(e) : f.push("url(" + e + ")"), d.push("100% 100%"), p.push("0 0"), g.push("multiply"));
					f.push("url(" + a.s.src + ")");
					d.push("auto");
				...
				clone: function(a) {
					...
					if (b && b.i)
						for (var d = 0; d < a.i.length; d++) b.add(u.clone(a.i[d]));
					return b
				}
			}
		}();
	...
	r.prototype = {
		...
		D: function() {
			...
			for (var a = this, b = d.create(0, 0, 0); a;) b = d.add(b, a.position), a = a.parent;
			return this.N = b
		}
	};
	J.prototype = {
		update: function(a) {
			...
			if (a)
				for (a = 0; a < this.i.length; a++) this.i[a].update(!0)
		},
		...
		remove: function(a) {
			for (var b = 0; b < this.i.length; b++)
				if (this.i[b] === a) return a.parent = null, a.node.parentNode.removeChild(a.node), this.i.splice(b, 1), a
		},
	...
	Q.prototype = {
		ja: function(a, b, c, f, k) {
			if (k = t.ga(this.position, this.direction, a, k)) {
				...
				if (0 < d.c(p, this.direction) && d.l(p) <= this.C && t.pa(a, b, c, f, k)) return k
			}
			return null
		},
		ia: function(a, b) {
	...
	q.prototype = {
		...
		ha: function() {
			...
			for (var c = Math.tan(t.G(this.F.x)), f = Math.tan(t.G(this.F.y)),
					k = d.create(-a - b * c, -b - a * f, 0), p = d.create(+a - b * c, -b + a * f, 0), g = d.create(+a + b * c, +b + a * f, 0), c = d.create(-a + b * c, +b - a * f, 0), f = this, l = d.K(this.w.g), e = d.K(this.w.a), m = d.K(this.w.h), h = d.K(this.w.d); f;) a = f.rotation, b = f.position, k = d.add(t.v(k, a), b), p = d.add(t.v(p, a), b), g = d.add(t.v(g, a), b), c = d.add(t.v(c, a), b), l = t.v(l, a), e = t.v(e, a), m = t.v(m, a), h = t.v(h, a), f = f.parent;
			this.O = [k, p, g, c];
			...
			if (L)
				for (var e = 0; e < d; e++)
					for (var m = 0; m < k; m++) {
						...
						for (e = 0; e < d; e++)
							for (m = 0; m < k; m++) h = c[e][m], 10 < d && 10 < k && (0 < e && c[e - 1][m] < h + 10 && (h = c[e - 1][m] / 2 + h / 2), e < d - 1 && c[e + 1][m] < h + 10 && (h = c[e + 1][m] / 2 + h / 2), 0 < m && c[e][m - 1] < h + 10 && (h = c[e][m - 1] / 2 + h / 2), m < k - 1 && c[e][m + 1] < h + 10 && (h = c[e][m + 1] / 2 + h / 2)), g[l + 3] = Math.min(230, 255 - h) | 0, l += 4;
	...
	window.onload = function() {
		...
		function l(d) {
			...
			var g = .0174532925 * u.u.rotation.y,
				...
				m = q.V(e, g);
			0 !== n.f || 0 !== n.b || 0 !== n.B ? (w && (w = clearTimeout(w)), r && (h.className = "hide", r = !1)) : w || (w = setTimeout(function() {
				h.className = "";
				r = !0
			}, 4E3));
		...
		q.ka("../map.png", function() {
			...
			document.addEventListener("mousemove", function(b) {
				!b.altKey && a && (b.movementX || b.movementY ? (n.rotation.y += b.movementX, n.rotation.x -= b.movementY) : (n.rotation.x -= (b.pageY - a.y) / 2, n.rotation.y += (b.pageX - a.x) / 2), n.rotation.x = Math.max(Math.min(n.rotation.x, 90), -90));
				a = {
					x: b.pageX,
					y: b.pageY
				}
